...
import { ProviderRouterBatchRoutes } from "./provider-router-batches";
import { ProviderRouterDocumentRoutes } from "./provider-router-document-routes";
import { ProviderRouterFinancialRoutes } from "./provider-router-financial-routes";
import { ProviderRouterHistoryRoutes } from "./provider-router-history";
import { ProviderRouterNewsRoutes } from "./provider-router-news";
import { ProviderRouterPrimaryRoutes } from "./provider-router-primary";
import { ProviderRouterSupplementalRoutes } from "./provider-router-supplemental";
import { ProviderRouterStreamingRoutes } from "./provider-router-streaming";
import {
  cacheRouterResource,
  getRouterEntityKey,
